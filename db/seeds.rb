...
agent = User.create(name: 'agent', password: '12345678', email: 'agent@black.com')
agent.phones.create(original: '89199992233')
...
[
    { offer_type: 1, category: 1, property_type: 1,  name: 'Сдам однушку',
      ...
      adv_type: 0, currency: 1, sales_agent: 'test agent', city_id: Location.find_by_title('Ялуторовск'), user_id: agent.id },
    { offer_type: 1, category: 1, property_type: 1,
      ...
      city_id: Location.find_by_title('Тюмень').id, district_id: Location.find_by_title('Восточный').id, user_id: agent.id },
    { offer_type: 1, category: 1, property_type: 1,  name: 'Сдам хрущевку',
      ...
      city_id: Location.find_by_title('Тюмень').id, district_id: Location.find_by_title('Заречный').id, user_id: agent.id },
    ...
    { offer_type: 0, category: 6, property_type: 0,
      ...
      adv_type: 0, currency: 1, sales_agent: 'test agent',
      city_id: Location.find_by_title('Тюмень').id, district_id: Location.find_by_title('Центр').id, user_id: agent.id },
    { offer_type: 0, category: 6, property_type: 0,
    ...
    { offer_type: 4, category: 2, property_type: 1,
      ...
      adv_type: 0, currency: 1, sales_agent: 'test agent',
      city_id: Location.find_by_title('Тюмень').id, district_id: Location.find_by_title('ЖД').id, user_id: agent.id },
    ...
    { offer_type: 0, category: 5, property_type: 0,
      ...
      adv_type: 0, currency: 1, sales_agent: 'test agent', city_id: 4, district_id: Location.find_by_title('Восточный').id, user_id: agent.id },
    { offer_type: 0, category: 5, property_type: 0,
      ...
      adv_type: 0, currency: 1, sales_agent: 'test agent', city_id: 4, district_id: Location.find_by_title('Центр').id, user_id: agent.id }
