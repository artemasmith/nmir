...
#ADVERTISMENTS
[
    { offer_type: 1, category: 1, property_type: 1, expire_date: Date.today + 1.month, name: 'Сдам однушку',
    ...
    { offer_type: 0, category: 6, property_type: 0,
      expire_date: Date.today + 1.month, name: 'Продам офис',
    ...
    { offer_type: 0, category: 6, property_type: 0,
      expire_date: Date.today + 1.month, name: 'Продам офисное помещение в районе кривоаанов',
    ...
    { offer_type: 4, category: 1, property_type: 1,
      expire_date: Date.today + 4.month, name: 'Куплю хату с краю',
    ...
    { offer_type: 0, category: 5, property_type: 0,
      expire_date: Date.today + 2.month, name: 'Продам гараж, в за бугром, охраняемый',
...
].each do |advertisment|
  a = Advertisment.find_or_create_by(advertisment)
