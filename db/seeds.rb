...
rc.sublocations.find_or_create_by(title: 'Центр', location_type: 'admin_area')
rc.sublocations.find_or_create_by(title: 'Заречный', location_type: 'admin_area')
rc.sublocations.find_or_create_by(title: 'Восточный', location_type: 'admin_area')
rc.sublocations.find_or_create_by(title: 'Восточный 2', location_type: 'admin_area')
rc.sublocations.find_or_create_by(title: 'Войновка', location_type: 'admin_area')
rc.sublocations.find_or_create_by(title: 'Мыс', location_type: 'admin_area')
rc.sublocations.find_or_create_by(title: 'Маяк', location_type: 'admin_area')
rc.sublocations.find_or_create_by(title: 'Ленина', location_type: 'street')
rc.sublocations.find_or_create_by(title: 'Республики', location_type: 'street')
rc.sublocations.find_or_create_by(title: 'Комсомольская', location_type: 'street')
rc.sublocations.find_or_create_by(title: 'Железнодорожная', location_type: 'street')
rc.sublocations.find_or_create_by(title: 'Первомайская', location_type: 'street')
rc.sublocations.find_or_create_by(title: 'Кузнецова', location_type: 'street')
rc.sublocations.find_or_create_by(title: 'Немцова', location_type: 'street')
rc.sublocations.find_or_create_by(title: 'Минская', location_type: 'street')
rc.sublocations.find_or_create_by(title: '50 лет Октября', location_type: 'street')
rc.sublocations.find_or_create_by(title: '50 лет ВЛКСМ', location_type: 'street')
rc.sublocations.find_or_create_by(title: 'Салтыкова-Щедрина', location_type: 'street')
rc.sublocations.find_or_create_by(title: 'Горького', location_type: 'street')
sl = rc.sublocations.find_or_create_by(title: 'Московский тракт', location_type: 'street')
rc.sublocations.find_or_create_by(title: 'Червишевский тракт', location_type: 'street')
rc.sublocations.find_or_create_by(title: 'Самарцева', location_type: 'street')
rc.sublocations.find_or_create_by(title: 'Салаирский тракт', location_type: 'street')
rc.sublocations.find_or_create_by(title: 'Старотобольский тракт', location_type: 'street')
rc.sublocations.find_or_create_by(title: 'Карла Маркса', location_type: 'street')
rc.sublocations.find_or_create_by(title: 'Калинина', location_type: 'street')
rc.sublocations.find_or_create_by(title: 'Зои Космодемьянской', location_type: 'street')
rc.sublocations.find_or_create_by(title: 'Мориса Тореза', location_type: 'street')
rc.sublocations.find_or_create_by(title: 'Профсоюзная', location_type: 'street')
sl2 = rc.sublocations.find_or_create_by(title: 'Щербакова', location_type: 'street')
...
#ADMIN
#User.find_or_create_by({ name: 'admin', email: 'admin@admin.ru', password: '12345678', role: :admin })
