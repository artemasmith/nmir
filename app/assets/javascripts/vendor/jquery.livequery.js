...
// Register core DOM manipulation methods
    $jQlq.registerPlugin('append', 'prepend', 'after', 'before', 'wrap', 'attr', 'removeAttr', 'addClass', 'removeClass', 'toggleClass', 'empty', 'remove', 'html', 'prop', 'removeProp', 'text', 'val');

// Run Live Queries when the Document is ready
    $(document).on('page:load page:update ready click ajaxStop', function(){$jQlq.play(); });
