ThinkingSphinx::Index.define :advertisement,
  ...
  %w(created_at updated_at price_from price_to adv_type property_type category offer_type mortgage not_for_agents status_type floor_from floor_cnt_from space_from outdoors_space_from floor_to floor_cnt_to space_to outdoors_space_to room_from room_to).each do |m|
    has m, as: m
  end
end
